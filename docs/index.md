...
4. [performance-deployment.md](performance-deployment.md)：理解CPU余量、NUMA、指令集和io_uring的生产准入。
5. [latency.md](latency.md)：理解零起点 URL 如何边下载边播放，以及首包的真实退化边界。
6. [implementation.md](implementation.md)：最后进入 source、codec、queue 和 RTP 的实现约束。
