...
mod tests {
    ...
    fn pcm(samples_per_channel: u32, value: f32) -> PcmFrame {
        PcmFrame {
            generation: 1,
            samples_per_channel,
            sample_rate: 48_000,
            ...
            samples: vec![value; samples_per_channel as usize * 2],
        }
    }
    ...
    fn libopus_encoder_encodes_float_stereo_frame() {
        ...
        let encoded = encoder.encode(&pcm(960, 0.0)).expect("encode");
